...
func parseFlags() (opts *agent.Options, showVersion bool) {
	...
	flag.BoolVar(&opts.RequirePairedDevice, "require-paired-devices", false, "Admit only devices that have paired, withdrawing the shared secret and loopback bypass for device connections. Browser clients are unaffected")
